          ...
          .map(
            (participant) => `
              <li>
                ...
                <button class="remove-participant" type="button" data-activity="${name}" data-email="${participant}" aria-label="Unregister ${participant}" title="Unregister participant">&times;</button>
              </li>`
          )
          .join("");
